...
def stub_topic():
    ...
    Topic.objects.create_topic(
        title="How awesome is DramaFever?",
        description="Trying to evaluate the level of awesomeness of DramaFever."
    )
...
def stub_comment():
    ...
    topic.comment_set.create(comment_text="I'd say it's as awesome as bacon!")
...
class CommentViewTests(TestCase):
    def test_the_creation_of_a_new_comment(self):
        ...
        self.assertContains(response, "DramaFever")
